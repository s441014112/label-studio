    ...
    if (extractedValues.length > 1) {
      ...
      return (
        <span className="flex gap-tighter flex-wrap">
          ...
          {hiddenCount > 0 && <span className="text-neutral-content-subtle text-sm">+{hiddenCount}</span>}
        </span>
      );
    }
    ...
    if (Array.isArray(extracted)) {
      return (
        <span className="flex gap-tighter flex-wrap">
          ...
          {extracted.length > 5 && (
            <span className="text-neutral-content-subtle text-sm">+{extracted.length - 5}</span>
          )}
        </span>
      );
    }
