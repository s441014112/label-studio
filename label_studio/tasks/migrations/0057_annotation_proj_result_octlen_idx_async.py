...
def get_sql_create_index(db_vendor):
    if db_vendor == 'postgresql':
        ...
        return (
            ...
            'ON `task_completion` (`project_id`, `id`);'
        )
    else:
        return None
...
def get_sql_drop_index(db_vendor):
    if db_vendor == 'postgresql':
        return 'DROP INDEX CONCURRENTLY IF EXISTS annotation_proj_result_octlen_idx;'
    elif db_vendor == 'mysql':
        return 'DROP INDEX `annotation_proj_result_octlen_idx` ON `task_completion`;'
    else:
        return None
