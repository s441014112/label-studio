...
actions: list[DataManagerAction] = [
    {
        ...
        'title': _S('dm.action.retrieve_predictions.title'),
        'order': 90,
        'dialog': {
            'title': _S('dm.action.retrieve_predictions.dialog_title'),
            'text': _S('dm.action.retrieve_predictions.dialog_text'),
            'type': 'confirm',
        },
    },
    {
        ...
        'title': _S('dm.action.delete_tasks.title'),
        'order': 100,
        'reload': True,
        'dialog': {
            'text': _S('dm.action.delete_tasks.dialog_text'),
            'type': 'confirm',
        },
    },
    {
        ...
        'title': _S('dm.action.delete_annotations.title'),
        'order': 101,
        'dialog': {
            'text': _S('dm.action.delete_annotations.dialog_text'),
            'type': 'confirm',
    ...
    },
    {
        ...
        'permission': all_permissions.predictions_any,
        'title': _S('dm.action.delete_predictions.title'),
        'order': 102,
        'dialog': {
            'text': _S('dm.action.delete_predictions.dialog_text'),
            'type': 'confirm',
        },
    },
]
